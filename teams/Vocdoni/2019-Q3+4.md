...
Our aim is a trustless voting system that anyone can run, where anyone speak his/her voice and where everything can be audited. We are engineering the building blocks for a permissionless, private and censorship resistant democracy and we belive that our platform can lead to very nice synergies within an ecosystem like Aragon's.

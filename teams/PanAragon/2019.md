...
* 1 Community, External Comms, Product Strategy: **María Paula Fernández**
Communications, product and community strategist for projects and products within the decentralized ecosystem, 8+ years of experience in communications and marketing. Currently leading Communications at [Golem](https://golem.network/), directing Department if Decentralization/ETHBerlin and consulting for the [Ethereum Community Fund](https://ecf.network/), dxDAO by [Gnosis](https://gnosis.pm/), PanAragon (Akropolis). Project Manager at Görli Testnet.

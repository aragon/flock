...
Aragon Black is a team whose core members come majoritarily from the PandoNetwork team [mostly known in the ecosystem for the development of the pando protocol]. The PandoNetwork team has been working closely with the Aragon ecosystem for almost a year now and has been the recipient of two Aragon Nest grants [[1]](https://github.com/aragon/nest/pull/31) [[2]](https://github.com/aragon/nest/pull/120).

To strengthen its commitment to the Aragon movement, the PandoNetwork team has decided to apply to the Flock program as Aragon Black. This first Flock proposal cover six months of work. However, if the Aragon community lend us its trust, we intend to re-apply to this program on the long run.

Our long term vision is to turn Aragon into the go-to choice to decentralize the governance of open-source projects and common goods. Thus, our work will focus on a. providing the tools to maintain open-source projects over Aragon [[I01]](#i01---aragon-development-infrastructure) [[I02]](#) ; b. providing the tools to experiment with new economic dynamics [[I03]](#) ; c. improve some core components of the Aragon stack [[I04]](#heading=h.sii5l2c38ve6) and ; d. on-board non-tech-savvy people and real common-driven projects into the Aragon Ecosystem [[I05]](#heading=h.pa11l8nmzo5v).
